  ...
  return (
    <div className="space-y-4">
      <div className="aspect-[2/3] bg-gray-100 rounded-lg overflow-hidden">
        <img
          src={currentView === 'front' ? book.coverImage : (book.backCoverImage || book.coverImage)}
          alt={`${currentView === 'front' ? 'Sampul depan' : 'Sampul belakang'} buku ${book.title}`}
...
export default function BookDetailPage() {
        ...
        <div className="min-h-screen bg-gray-50 py-8">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center py-12">
              ...
              <h1 className="text-2xl font-bold text-gray-900 mb-2">Buku Tidak Ditemukan</h1>
  ...
  const emailSubject = encodeURIComponent(`Pertanyaan tentang buku: ${book.title}`);
  ...
  const emailUrl = `mailto:contact@publisher.com?subject=${emailSubject}&body=${emailBody}`;
  ...
  return (
    <>
      <Seo 
        ...
        keywords={`${book.title}, ${book.author}, ${getCategoryName(book.category)}, buku islam`}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-white rounded-lg shadow-sm overflow-hidden">
            <div className="lg:grid lg:grid-cols-2 lg:gap-8 p-6 lg:p-8">
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <p className="text-lg text-gray-600 mb-2">Oleh: <span className="font-semibold">{book.author}</span></p>
                  <p className="text-sm text-blue-600 font-medium">Kategori: {getCategoryName(book.category)}</p>
                </div>
                ...
                {/* Book Details */}
                <div>
                  <h2 className="text-xl font-semibold text-gray-900 mb-3">Detail Buku</h2>
                ...
                <div className="bg-green-50 p-4 rounded-lg">
                  ...
                  <p className="text-2xl font-bold text-green-600">{formatPrice(book.price)}</p>
                </div>
            ...
            <div className="border-t border-gray-200 p-6 lg:p-8 space-y-8">
              ...
              {book.authorBio && (
                <div>
                  <h2 className="text-2xl font-bold text-gray-900 mb-4">Tentang Penulis</h2>
                  <div className="bg-gray-50 rounded-lg p-6">
                    <div className="flex items-start space-x-4">
                      ...
                      <div>
                        <h3 className="font-semibold text-gray-900 mb-2">{book.author}</h3>
              ...
              {book.quote && (
                <div>
                  <h2 className="text-2xl font-bold text-gray-900 mb-4">Kutipan dari Buku</h2>
                  <blockquote className="bg-blue-50 border-l-4 border-blue-400 p-6 rounded-r-lg">
                    <p className="text-lg italic text-gray-800 leading-relaxed">{book.quote}</p>
                  </blockquote>
                </div>
              )}
            </div>
